    ...
    <b-card no-body>
      ...
      <b-card-body title="Información Personal">
        <b-card-text>
          ...
          <div v-if="!edit_flag">
            <label> <b>Teléfono fijo:</b> {{ graduando.telefono_fijo }} </label>
            <br />
            <label>
              <b>Teléfono móvil:</b> {{ graduando.telefono_movil }}
            </label>
            <br />
            <label> <b>Dirección:</b> {{ graduando.direccion }} </label> <br />
            <b-button variant="success" @click="changeEdit"
          ...
          <div v-else>
            <b-form @submit.prevent="actualizarDatos">
              ...
              >
                ...
                ></b-form-input>
                <span v-if="errors.telefono_fijo" class="text-danger">{{
                  errors.telefono_fijo[0]
                }}</span>
              </b-form-group>
              <b-form-group
              ...
              >
                <b-form-input
                  ...
                  required
                ></b-form-input>
                <span v-if="errors.telefono_movil" class="text-danger">{{
                  errors.telefono_movil[0]
                }}</span>
              </b-form-group>
              <b-form-group
