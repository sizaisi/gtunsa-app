      ...
      <b-container>
        ...
        >
          <b-row>
            <b-col
              v-if="
                grado_proc_mov.idgradproc_origen == idgrado_procedimiento_actual
              "
            >
              <estado-component
                :ruta="ruta"
            ...
            <b-col
              v-else-if="
                grado_proc_mov.nro_orden < orden_actual_en_movimiento ||
                grado_proc_mov.idgradproc_origen ==
                  movimientos[movimientos.length - 1].idgradproc_origen
              "
            >
              <estado-component
                :title="grado_proc_mov.nombre_procedimiento"
        ...
        <b-collapse v-model="showRest">
          <div
            v-for="(grado_proc_rest, index) in resto_grado_procedimientos"
            :key="index"
          >
            <b-row>
              <b-col>
    ...
    calcularEstadosConMovimientos() {
      for (let i = 0; i < this.movimientos.length; i++) {
        ...
        var index = this.mov_grado_procedimientos.findIndex(
          (item) => item.idgradproc_origen === objMovimiento.idgradproc_origen
        );
